...
currency_keyboard = ('USD', 'EUR', 'GBP', 'Else')
currency_keyboard_callback = ('usd', 'eur', 'gbp', 'else')


async def inline_keyboard(type_of_file):
    global list1, list2
    keyboard = InlineKeyboardBuilder()
    if type_of_file == 'start':
        list1 = start_keyboard
        list2 = start_keyboard_callback
    elif type_of_file == 'currency':
